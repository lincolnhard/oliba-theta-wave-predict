...
$neutral_word    = array_rand($neutral_array, 25);
...
$i   = array();
$seq = array();
shuffle($unselected_word);
for ($index = 0; $index < 50; $index++) {
    $c[]   = $negative_array[$unselected_word[$index]];
    $seq[] = 'c_'.$index;
}
...
<form id="check-form" action="/check2-intro.php" method="post">
    ...
    <input type="hidden" name="check1_neutral" value="<?php echo implode(',', $neutral_word); ?>" />
    <input type="hidden" id="check-result" name="check1_result" value="" />
</form>
<script>
